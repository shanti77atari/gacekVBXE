...
pe1		
		...
		adc #89+t_score				 
		sta sprite_typ,y
		mva #-1 sprite_anim_speed,y		;nie animuj
		mva #30 sprite_score_licznik,y
		inc ile_score
		ldx ile_paraliz
