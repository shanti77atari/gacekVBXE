...
@		lda tab_anim0+$34,y
		...
		lda #0
		ldy #7
@		:6 sta znaki+$3f8+,y			;ostatni znak bedzie czarny
		dey
		bpl @- */
...
rr0		ldy pom0a
		...
		;adc #POSY_MIN
		ldx pom0b
		sta rampa_y1,x		;pozycja Y rampy
		adc #POSY_MIN
		sta rampa_y,x
		dey
		...
		;:3 asl
		;adc #15
		sta rampa_dy1,x			;dlugosc w pion
		:3 asl
		adc #15
		sta rampa_dy,x
		jmp @+1	
@		sta _ryspos+1			;poziom
		...
		;:2 asl
		;adc #3
		sta rampa_dx1,x		;dlugosc w poziomie
		:2 asl
		adc #3
		sta rampa_dx,x
...
@		lda (pom1),y
		...
		asl
		;adc #POSX_MIN
		sta rampa_x1,x		;pozycja Y rampy
		pla
		adc #POSX_MIN
		sta rampa_x,x
...
stale_znaki
			...
			.he 00,0c,3c,0c,0c,3f,00,00		;1
			.he 00,3c,03,3f,30,3f,00,00		;2
			.he 00,3f,03,0f,03,3f,00,00		;3
			.he 00,33,33,3f,03,03,00,00		;4
			.he 00,3f,30,3f,03,3f,00,00		;5
