...
paraliz_tab0	equ *-1
				.he 00,d0,e0,00,00,d0,60
paraliz_tab1	equ *-1
				.he 20,00,00,80,c0,d0,60
paraliz_tab2	equ *-1
				.he a0,00,a0,00,c0,00,60
				
paraliz_tab0a	equ *-1
				.he 60,ff,ff,40,70,ff,b0
paraliz_tab1a	equ *-1
				.he 80,70,90,ff,ff,ff,b0
paraliz_tab2a	equ *-1
				.he ff,70,d0,40,ff,40,b0				
...
@			lda tab_globus2,x
			...
			mva #<(panel_adr+48) dlist0+33-4
			sta dlist1+31
			mva #>(panel_adr+48) dlist0+34-4
			sta dlist1+32
			mva #0 dlist0+35-4
			sta dlist1+33			
...
loop1			
			...
			jsr init_level
			jsr POZ.nowy_poziom				
			jsr deco.rysuj_rampe1		
			jsr deco.draw_screen
			jsr POZ.dodaj_bomby
			jsr wait_vbl
			mva #$3b dmactl
			ldy	#$40	; VIDEO_CONTROL
